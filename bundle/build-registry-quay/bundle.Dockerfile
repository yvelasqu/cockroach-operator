...
LABEL operators.operatorframework.io.bundle.package.v1=cockroach-operator-test
...
COPY 1.0.0 /manifests/
COPY cockroach-operator.package.yaml /metadata/
COPY annotations.yaml /metadata/
